(function () {
  ...
  const en = {
    "RORAIMA MÉXICO · COLECCIONES DE ÓPTICA DE LUJO": "RORAIMA MEXICO · LUXURY EYEWEAR COLLECTIONS",
    "DESCUBRE LAS COLECCIONES": "DISCOVER THE COLLECTIONS",
    "Explora cada firma y sus modelos.": "Explore each brand and its models.",
    "Ver catálogo Silhouette →": "View Silhouette catalogue →",
    "Cómo elegir": "How to choose",
    "Soy una óptica / Profesional": "I am an optical professional",
    "Dos firmas.": "Two brands.",
    "Descubre colecciones de diseño, ingeniería y carácter, explora cada modelo y encuentra dónde probarlo con asesoría especializada.": "Discover collections defined by design, engineering and character, explore every model and find expert help near you.",
    "Encontrar una óptica Silhouette": "Find a Silhouette optician",
    "Precisión, confort y una estética depurada. Silhouette reúne ingeniería austríaca y monturas ultraligeras para una experiencia visual contemporánea.": "Precision, comfort and a refined aesthetic. Silhouette brings together Austrian engineering and ultralight frames for a contemporary visual experience.",
    "TU RECORRIDO B2C": "YOUR CONSUMER JOURNEY",
    "Descubre.": "Discover.",
    "Compara. Encuentra.": "Compare. Find.",
    "Explora las colecciones, revisa cada producto y encuentra una óptica autorizada para recibir asesoría, disponibilidad y atención de compra.": "Explore the collections, review every product and find an authorized optician for advice, availability and purchase assistance.",
    "Compara": "Compare",
    "Revisa modelos, colores, materiales y detalles.": "Review models, colors, materials and details.",
    "Elige": "Choose",
    "Guarda mentalmente tus modelos favoritos para consultarlos.": "Keep your favorite models in mind for your consultation.",
    "Encuentra": "Find",
    "Localiza una óptica Silhouette y recibe asesoría especializada.": "Find a Silhouette optician and receive expert advice.",
    "Encontrar una óptica": "Find an optician",
    "Dos universos de marca. Una guía especializada.": "Two brand universes. One expert guide.",
    "Roraima Distribuciones presenta en México las colecciones de Alfred Kerbs y Silhouette y conecta a cada persona con atención especializada.": "Roraima Distribuciones presents the Alfred Kerbs and Silhouette collections in Mexico and connects each person with expert assistance.",
  ...
  const fr = {
    ...en,
    "RORAIMA MÉXICO · COLECCIONES DE ÓPTICA DE LUJO": "RORAIMA MEXIQUE · COLLECTIONS DE LUNETTERIE DE LUXE",
    "DESCUBRE LAS COLECCIONES": "DÉCOUVREZ LES COLLECTIONS",
    "Explora cada firma y sus modelos.": "Explorez chaque marque et ses modèles.",
    "Ver catálogo Silhouette →": "Voir le catalogue Silhouette →",
    "Cómo elegir": "Comment choisir",
    "Soy una óptica / Profesional": "Je suis opticien / professionnel",
    "Dos firmas.": "Deux marques.",
    "Descubre colecciones de diseño, ingeniería y carácter, explora cada modelo y encuentra dónde probarlo con asesoría especializada.": "Découvrez des collections de design, d’ingénierie et de caractère, explorez chaque modèle et trouvez un conseil spécialisé près de chez vous.",
    "Encontrar una óptica Silhouette": "Trouver un opticien Silhouette",
    "Precisión, confort y una estética depurada. Silhouette reúne ingeniería austríaca y monturas ultraligeras para una experiencia visual contemporánea.": "Précision, confort et esthétique épurée. Silhouette réunit ingénierie autrichienne et montures ultralégères pour une expérience visuelle contemporaine.",
    "TU RECORRIDO B2C": "VOTRE PARCOURS CONSOMMATEUR",
    "Descubre.": "Découvrez.",
    "Compara. Encuentra.": "Comparez. Trouvez.",
    "Explora las colecciones, revisa cada producto y encuentra una óptica autorizada para recibir asesoría, disponibilidad y atención de compra.": "Explorez les collections, consultez chaque produit et trouvez un opticien agréé pour obtenir conseils, disponibilité et accompagnement.",
    "Compara": "Comparez",
    "Revisa modelos, colores, materiales y detalles.": "Examinez les modèles, coloris, matériaux et détails.",
    "Elige": "Choisissez",
    "Guarda mentalmente tus modelos favoritos para consultarlos.": "Gardez vos modèles favoris en tête pour votre consultation.",
    "Encuentra": "Trouvez",
    "Localiza una óptica Silhouette y recibe asesoría especializada.": "Trouvez un opticien Silhouette et bénéficiez de conseils spécialisés.",
    "Encontrar una óptica": "Trouver un opticien",
    "Dos universos de marca. Una guía especializada.": "Deux univers de marque. Un guide spécialisé.",
    "Roraima Distribuciones presenta en México las colecciones de Alfred Kerbs y Silhouette y conecta a cada persona con atención especializada.": "Roraima Distribuciones présente au Mexique les collections Alfred Kerbs et Silhouette et met chacun en relation avec un accompagnement spécialisé.",
